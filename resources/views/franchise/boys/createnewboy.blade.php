...
@endif
                           ...
                           <div class="p-1 pt-3">
                             ...
                             <form method="post" action="{{route('insertnewboy')}}" enctype='multipart/form-data'>
                             @csrf  
                             <div class="row mb-3">
                                 <div class="col-sm-12">
                                   <input type="text" value="{{old('name')}}" class="form-control" placeholder="Name" name="name" required>
                                 </div>
                               </div>
                               <div class="row mb-3">
                                 <div class="col-sm-12">
                                   <input type="number" value="{{old('mobile')}}" class="form-control" placeholder="Number" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==10) return false;"  name="mobile" required>
                                 </div>
                               </div>
                               ...
                               <div class="row mb-3">
                                 <div class="col-sm-12">
                                   <input type="password" class="form-control" value="{{old('password')}}" placeholder="Password" name="password" required>
                                 </div>
                               </div>
                               ...
                               <div class="row mb-3">
                                 <div class="col-sm-12">
                                    Aadhar:
                                   <input type="file" class="form-control" placeholder="Aadhar" accept="application/pdf"  name="aadhar" required>
                                 </div>
                               </div>
                               <div class="row mb-3">
                                 <div class="col-sm-12">
                                    Pan Card:
                                   <input type="file" class="form-control" accept="application/pdf"  name="pan" required>
                                 </div>
                               </div>
                               <div class="row mb-3">
                                 <div class="col-sm-12">
                                    Driving Licience:
                                   <input type="file" class="form-control" accept="application/pdf" name="licience" required>
                                 </div>
                               </div>
