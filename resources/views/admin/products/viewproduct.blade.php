...
<div class="col-lg-12">
                        ...
                        @if(session()->has('message'))
                            ...
                            @endif
                           <h5  class="card-title text-center bg-light">Edit Coupons</h5>
             
                           <!-- General Form Elements -->
                           <div class="p-1 pt-3">
             
                             <form method="post" action="{{route('insertproductedit')}}" >
                             @csrf  
                             <div class="row mb-3">
                                 <div class="col-sm-12">
                                   <input type="text" class="form-control" placeholder="copouncode" name="name"  value="{{$product->name}}" required>
                                   <input type="hidden" class="form-control" placeholder="copouncode" name="id"  value="{{$product->id}}">
                                 </div>
                               </div>
                               <div class="row mb-3">
                                 <div class="col-sm-12">
                               ...
                               <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                 <div class="col-sm-12">
                                   <input type="text" class="form-control"  placeholder="price" name="dimensions" value="{{$product->dimensions}}" required>
                                 </div>
                               </div>
                               ...
                               <div class="row mb-3">
                                 <div class="col-sm-12">
                                     <select class="form-select" name="status" value="{{$product->status}}" aria-label="Default select example" data-live-search="true" data-live-search-placeholder="Search for a state">
