...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Manage Collections</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="col-lg-9 col-md-9 justify-content-around">
            <h5 class="card-title">Manage Collections</h5>
        </div>
        ...
        <table class="table datatable table-striped">
          ...
          @foreach($data as $i => $row )
            ...
            <tr>
              ...
              <td>
                <a href="{{url('boy/testreqform/' . $row->id)}}" class="btn btn-sm btn-success" >update</a>              
              </td>              
            </tr>
            @endforeach
          </tbody>
