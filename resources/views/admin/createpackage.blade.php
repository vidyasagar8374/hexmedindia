...
@endif
                           ...
                           <div class="p-1 pt-3">
                             ...
                             <form method="post" action="{{route('createnewpackage')}}">
                              @csrf
                               <div class="row mb-3">
                                 <div class="col-sm-12">
                               ...
                               <div class="row mb-3">
                                 <div class="col-sm-12">
                                   <input type="number" class="form-control" placeholder="Price of the Package" name="price" required>
                                 </div>
                               </div>
                               <div class="row mb-3">
                                 <div class="col-sm-12">
                                   <input type="number" class="form-control" placeholder="Franchise Price of the Package" name="adminprice" required>
                                 </div>
                               </div>
