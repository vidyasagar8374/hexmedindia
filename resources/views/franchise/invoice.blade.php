    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="width: 50%; padding: 20px; vertical-align: top">
          ...
          <p style="margin: 0 0 10px 0; padding: 0; font-size: 14px;"><span style="display: block; font-weight: bold; font-size: 13px;">Number of guests</span> 2</p>
      ...
      <tr>
        <td colspan="2" style="padding: 15px;">
          <p style="font-size: 14px; margin: 0; padding: 10px; border: solid 1px #ddd; font-weight: bold;">
            <span style="display: block; font-size: 13px; font-weight: normal; padding-bottom: 10px;">Total Amount <span style="font-weight: 700;">&nbsp; Rs. 3500₹ /- </span></span>
          </p>
        </td>
      </tr>
    </tbody>
    <tfoot>
      <tr>
        <td colspan="2" style="font-size: 14px; padding: 30px 15px 0 15px;">
          ...
          <b>Email:</b> contact@bachanatours.in<br><br>
          <b>Declaration:</b> * This is a computer-generated invoice and does not require a physical signature
        </td>
      </tr>
    </tfoot>
  </table>
