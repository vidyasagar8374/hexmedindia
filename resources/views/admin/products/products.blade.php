...
<div class="col-lg-12">
                        ...
                        @if(session()->has('message'))
                            ...
                            @endif
                           <h5  class="card-title text-center bg-light">Create Products</h5>
                           ...
                           <div class="p-1 pt-3">
                             ...
                             <div class="row mb-3">
                               ...
                               <div class="row mb-3">
                                 <div class="col-sm-12">
                                   <input type="text" class="form-control" placeholder="desciption" name="description" required>
                                 </div>
                               </div>
                               ...
                               <div class="row mb-3">
                                 <div class="col-sm-12">
                                   <input type="text" class="form-control" placeholder="Dimensions" name="dimensions" required>
                                 </div>
                               </div>
